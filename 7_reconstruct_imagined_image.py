'''
Reconstruct imagined image from CNN features decoded from the brain.
...
# Feature SD estimated from true CNN (VGG19 with leaky ReLU layers and average pooling layers) features of 10000 images
...
# The image used in Figure 8, the image label can be from 1 to 26 for imagined images in test data
image_label_list = [1, 5, 9, 8, 3, 10, 21, 22, 20]
