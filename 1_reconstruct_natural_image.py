...
image_label_list = [4,9,2,36,45,16] # the image used in Figure 2(a), the image label can be from 1 to 50 for natural images in test data
...
opts = {
    ...
    'initial_gen_feat': initial_gen_feat, # the initial features of the input layer of the generator (setting to None will use random noise as initial features)
