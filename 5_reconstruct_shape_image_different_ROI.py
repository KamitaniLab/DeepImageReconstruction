...
# Reconstructions of colored artificial shapes obtained from multiple visual areas;
# conditions:
...
ROIs = ['V1','V2','V3','V4','HVC','VC']

image_label_list = [4,8,11] # the image used in Figure 3(c), the image label can be from 1 to 40 for colored artificial shape images in test data
