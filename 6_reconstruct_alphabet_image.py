# Here the codes are used to reconstruct alphabetical letters from the CNN features decoded from brain;
# conditions:
# ROI: VC
...
stim_type = 'alphabet' # for alphabetical letter image
...
image_label_list = range(1,11) # the image used in Figure 3(e), the image label can be from 1 to 10 for alphabetical letter images in test data
