...
layer_combinations['layers_1to5'] = layer_set1 + \
    layer_set2 + layer_set3 + layer_set4 + layer_set5

layer_combinations['layers_1to7'] = layer_set1 + layer_set2 + \
    layer_set3 + layer_set4 + layer_set5 + layer_set6 + layer_set7
    ...
    for ROI in ROIs:  # loop for ROIs
        for image_label in image_label_list:  # loop for image label
            for combination_name, layers in layer_combinations.iteritems():  # loop for layer_combinations
                ...
                # save the results
                save_name = 'recon_img' + '_' + subject + '_' + ROI + \
                    '_' + combination_name + '_Img%04d.mat' % image_label
                ...
                save_name = 'recon_img' + '_' + subject + '_' + ROI + \
                    '_' + combination_name + '_Img%04d.jpg' % image_label
