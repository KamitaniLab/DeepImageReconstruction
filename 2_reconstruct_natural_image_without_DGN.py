...
# without using deep generator network (without DGN) to constrain the reconstrcuted image;
# conditions:
# ROI: VC
...
image_label_list = [2,45] # the image used in Figure 2(b), the image label can be from 1 to 50 for natural images in test data
